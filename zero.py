...
* Release History
    ...
    Oct 26, 2021 (1.3)
        - 'generalScore' analysis_function added
        - 'version check' added when starting program
...
def load_file():
    try:
        ...
        bt_prepro = tk.Button(frame_prepro, text = '데이터 전처리', overrelief = 'solid', command = lambda:prepro())
